import { SignUpFormData, signUpSchema } from "@/schemas/validationSchemas";
            ...
            <Controller
              ...
              render={({ field: { onChange, onBlur, value } }) => {
                const showEmailError =
                  !!errors.email && value.trim().length > 0;
            ...
            <Controller
              ...
              render={({ field: { onChange, onBlur, value } }) => {
                const showConfirmPasswordError =
                  !!errors.confirmPassword && value.trim().length > 0;
                  ...
                  <>
                    <View style={styles.inputContainer}>
                      ...
                      <TextInput
                        style={[
                          styles.input,
                          showConfirmPasswordError ? styles.inputError : null,
                        ]}
                        onBlur={onBlur}
                        onChangeText={onChange}
                        value={value}
